...
final class Coordinator: NSObject, UITextViewDelegate {
    internal let textView: CustomUITextView2
    ...
    func textViewDidChange(_ textView: UITextView) {
        text.wrappedValue = NSMutableAttributedString(attributedString: textView.attributedText)
        recalculateHeight()
        onEditingChanged?()
    }
    ...
    func update(representable: TextViewRepresentable) {
